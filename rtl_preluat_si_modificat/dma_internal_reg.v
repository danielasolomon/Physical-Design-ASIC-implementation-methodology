...
// Increment the write/read counter according to byte_wire, half word or word mode
...
assign byte_wire = dma_register6[0] & 32'd1;
	...
	begin
		...
		begin
			case (dma_host_addr)
				...
				24'h080003:	dma_register[3] <= dma_host_datain;	// Length in byte_wires
